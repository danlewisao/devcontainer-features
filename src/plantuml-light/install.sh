...
PLANTUML_INSTALL_DIR=/usr/share/plantuml

apt-get update && sudo apt-get install -y graphviz default-jre

mkdir -p ${PLANTUML_INSTALL_DIR}
cd ${PLANTUML_INSTALL_DIR}
curl -JLO ${PLANTUML_DOWNLOAD_URL}
